...
scramble4_to = 0x2E74       # End of ELITE4 file
scramble4_eor = 0xA5
...
# to be assembled with by default. LOAD's own adaptive patch (see CHK55FF in
# elite-loader3.asm) overwrites this value at load time to match whichever
# state is actually in force, so this is really just a sensible,
# self-consistent default for T.CODE's own on-disk copy of &55FF, in case
# that runtime patch is ever bypassed (e.g. checksums disabled)
